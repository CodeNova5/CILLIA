...
import {
  ...
  Truck, ShieldCheck, RotateCcw, Headphones, Instagram, Facebook,
  Youtube, ArrowRight, Sparkles, Mail, Quote, Leaf, Award, Play
} from "lucide-react";
  ...
  return (
    <section className="max-w-[1280px] mx-auto px-6 pt-6 grid grid-cols-1 lg:grid-cols-[1.65fr_1fr] gap-4">
      <div className="relative rounded-[6px] overflow-hidden bg-[#F3D8DA] min-h-[420px] lg:min-h-[560px] flex items-end">
        <Placeholder label="Hero — model portrait, soft pink tones" className="absolute inset-0" tone="blush" />
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2 text-[#211D1B]/60">
            <Instagram size={16} /> <Facebook size={16} /> <Youtube size={16} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pb-12 border-b border-white/10">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 text-white/60">
              <Instagram size={16} /> <Facebook size={16} /> {/* pinterest / tiktok icons omitted, add per assets */}
            </div>
          </div>
          {cols.map((c) => (
            <div key={c.title}>
